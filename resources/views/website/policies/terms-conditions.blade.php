...
<section class="section">
    <div class="container">
        ...
        <p>Welcome to Artificial Gehna!</p>

        <p>These terms and conditions outline the rules and regulations for the use of Artificial Gehna's Website,
            located at https://artificialgehna.com/.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Artificial
            Gehna if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <h4><strong>Purchase Invoice Terms & Conditions</strong></h4>
        <p>
            You can generate your order's invoice which will include the details of buyer and sellers. Details like
            name, phone number, email id and address.
        </p>
        <p>
            Invoice contains list products you purchased from website. Invoice will have some other details of order
            like order number, order date, total price etc.
        </p>
        <p>
            The invoice will be system generated, it does not require any signaure or stamp.
        </p>
        <h4><strong>Cookies</strong></h4>

        <p>We employ the use of cookies. By accessing Artificial Gehna, you agreed to use cookies in agreement with the
            Artificial Gehna's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, Artificial Gehna and/or its licensors own the intellectual property rights for all
            material on Artificial Gehna. All intellectual property rights are reserved. You may access this from
            Artificial Gehna for your own personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from Artificial Gehna</li>
            <li>Sell, rent or sub-license material from Artificial Gehna</li>
            <li>Reproduce, duplicate or copy material from Artificial Gehna</li>
            <li>Redistribute content from Artificial Gehna</li>
        </ul>

        <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the <a
                href="https://www.termsfeed.com/terms-conditions-generator/">TermsFeed Free Terms and Conditions
                Generator</a>.</p>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Artificial Gehna does not filter, edit, publish or review Comments prior to their
            presence on the website. Comments do not reflect the views and opinions of Artificial Gehna,its agents
            and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions.
            To the extent permitted by applicable laws, Artificial Gehna shall not be liable for the Comments or for any
        ...
        <p>Artificial Gehna reserves the right to monitor all Comments and to remove any Comments which can be
        ...
        <p>You hereby grant Artificial Gehna a non-exclusive license to use, reproduce, edit and authorize others to
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            Artificial Gehna; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to Artificial Gehna. Please include your name, your organization
        ...
        <p>No use of Artificial Gehna's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
