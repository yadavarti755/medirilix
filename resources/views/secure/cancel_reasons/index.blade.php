...
@canany(['add cancel reason', 'edit cancel reason'])
{{-- Modal --}}
...
<script @cspNonce>
    ...
    $(document).ready(function() {
        ...
        dataTable = $('#datatable').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: "{{ route('cancel-reasons.fetch.data') }}",
                type: "GET",
                data: function(d) {
    ...
    $(document).ready(function() {
        ...
        $('#form').on('submit', function(event) {
            ...
            if (operationType == 'EDIT') {
                url = "{{ route('cancel-reasons.update', ':id') }}".replace(':id', recordId);
                formData.append('_method', 'PUT'); // Needed for PUT requests via FormData
            } else if (operationType == 'ADD') {
                url = "{{ route('cancel-reasons.store') }}";
            } else {
                return false;
            }
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            if (id) {
                operationType = "EDIT";
                $.ajax({
                    url: "{{ route('cancel-reasons.fetch.one', ':id') }}".replace(':id', id),
                    type: 'GET',
                    headers: {
            ...
            if (id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('cancel-reasons.delete', ':id') }}".replace(':id', id),
