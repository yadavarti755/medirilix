...
@canany(['add product type', 'edit product type'])
{{-- Modal --}}
...
<script @cspNonce>
    ...
    $(document).ready(function() {
        ...
        dataTable = $('#datatable').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: "{{ route('product-types.fetch-for-datatable') }}",
                type: "POST",
                data: function(d) {
    ...
    $(document).ready(function() {
        ...
        $('#form').on('submit', function(event) {
            ...
            if (operationType == 'EDIT') {
                url = "{{ route('product-types.update', ':id') }}".replace(':id', recordId);
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            if (id) {
                operationType = "EDIT";
                $.ajax({
                    url: "{{ route('product-types.fetch-one', ':id') }}".replace(':id', id),
                    type: 'GET',
                    headers: {
            ...
            if (id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('product-types.destroy', ':id') }}".replace(':id', id),
                            type: "POST",
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
