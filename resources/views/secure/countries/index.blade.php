...
@canany(['add country', 'edit country'])
{{-- Modal --}}
            ...
            <form class="form" id="form">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control text-uppercase" name="iso2" id="iso2" maxlength="2">
                    </div>
...
<script @cspNonce>
    ...
    $(document).ready(function() {
        ...
        dataTable = $('#datatable').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: "{{ route('countries.fetch-for-datatable') }}",
                type: "POST",
                data: function(d) {
    ...
    $(document).ready(function() {
        ...
        $('#form').on('submit', function(event) {
            ...
            if (operationType == 'EDIT') {
                url = "{{ route('countries.update', ':id') }}".replace(':id', recordId);
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            if (id) {
                operationType = "EDIT";
                $.ajax({
                    url: "{{ route('countries.fetch-one', ':id') }}".replace(':id', id),
                    type: 'GET',
                    headers: {
