                ...
                <form id="roleForm">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6 col-sm-6 col-12">
                            ...
                            <input type="text" name="landing_page_url" class="form-control" placeholder="Enter landing page url">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check d-flex gap-3 flex-wrap flex-column">
                            ...
                            <div class="w-100">
                                <div class="d-flex align-items-center">
                                    <!-- Select Group -->
                                    <div class="form-check">
                                        <input class="form-check-input selectGroup" type="checkbox" data-group-name="{{ str_replace(' ', '', $group) }}" name="selectGroup" id="selectGroup_{{ str_replace(' ', '', $group) }}">
                                    </div>
                                    <label for="selectGroup_{{ str_replace(' ', '', $group) }}" class="mt-1 fw-semibold">{{ $group }} Permissions</label>
                                </div>
                                <hr class="mb-0 mt-2"> <!-- Divider -->
                            </div>
                        ...
                        <div id="permissions-error" class="text-danger"></div> <!-- Custom error placement -->
                    </div>
        ...
        $("#roleForm").validate({
            ...
            errorPlacement: function(error, element) {
                if (element.attr("name") === "permissions[]") {
                    error.appendTo("#permissions-error"); // Append error below checkboxes
                } else {
