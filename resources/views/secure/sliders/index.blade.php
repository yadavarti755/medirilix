        ...
        <div class="card">
            <div class="card-body">
                <div class="dt-responsive">
                    <table id="sliders-datatable" class="table table-striped table-bordered w-100">
                        <thead>
                            <tr>
                                <th>Sl. No.</th>
                                <th>File</th>
...
<script @cspNonce>
    $(document).ready(function() {
        $('#sliders-datatable').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: "{{ route('sliders.fetch-for-datatable') }}",
                type: "POST",
                data: function(d) {
        ...
        $(document).on('click', '.delete-slider', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('sliders.destroy', ':id') }}".replace(':id', roleId),
                        type: "POST",
                        headers: {
