...
@canany(['add material', 'edit material'])
{{-- Modal --}}
...
<script @cspNonce>
    ...
    $(document).ready(function() {
        ...
        dataTable = $('#datatable').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: "{{ route('materials.fetch-for-datatable') }}",
                type: "POST",
                data: function(d) {
    ...
    $(document).ready(function() {
        ...
        $('#form').on('submit', function(event) {
            ...
            if (operationType == 'EDIT') {
                url = "{{ route('materials.update', ':id') }}".replace(':id', recordId);
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            if (id) {
                operationType = "EDIT";
                $.ajax({
                    url: "{{ route('materials.fetch-one', ':id') }}".replace(':id', id),
                    type: 'GET',
                    headers: {
