...
!(function (o) {
    ...
    "function" == typeof define && define.amd
        ...
        ? ((n = require("jquery")),
          ...
          "undefined" == typeof window
              ...
              : (s(window, n),
                (module.exports = o(n, window, window.document))))
    ...
    R.fn.dataTableExt.oApi.fnColReorder = function (o, t, e, n, s) {
        ...
        if (t != e)
            if (t < 0 || h <= t)
                ...
                for (p = 0, i = h; p < i; p++) {
                    for (
                        a = 0, l = (u = o.aoColumns[p]).aDataSort.length;
                        a < l;
                        a++
                    )
                ...
                if (o.aoColumns[t].bVisible) {
                    ...
                    for (
                        p = 0,
                            i = (f = o.nTHead.getElementsByTagName("tr"))
                                .length;
                        p < i;
                        p++
                    )
                    ...
                    if (null !== o.nTFoot)
                        for (
                            p = 0,
                                i = (f = o.nTFoot.getElementsByTagName("tr"))
                                    .length;
                            p < i;
                            p++
                        )
                ...
                for (
                    (!s && s !== b) ||
                        R.fn.dataTable.Api(o).rows().invalidate("data"),
                        p = 0,
                        i = h;
                    p < i;
                    p++
    ...
    function r(t, e) {
        ...
        return (
            o && (o(r.defaults, r.defaults, !0), o(r.defaults, e || {})),
            (this.s = {
                dt: null,
                enable: null,
                init: R.extend(!0, {}, r.defaults, e),
                fixed: 0,
                fixedRight: 0,
    ...
    return (
        R.extend(r.prototype, {
            ...
            fnOrder: function (t, e) {
                ...
                if (e) {
                    for (
                        var s = this.fnOrder(), r = 0, i = t.length;
                        r < i;
                        r++
                    )
                ...
                if (null !== this.s) {
                    ...
                    if (((t.ColReorder = []), t.aaSorting)) {
                        for (s = 0; s < t.aaSorting.length; s++)
                            t.aaSorting[s][0] =
                                o[t.aaSorting[s][0]]._ColReorder_iOrigCol;
                        for (
                            var n = R.extend(!0, [], t.aoSearchCols),
                                s = 0,
                                r = o.length;
                            s < r;
                            s++
                        ...
                        for (s = 0; s < t.order.length; s++)
                            t.order[s][0] =
                                o[t.order[s][0]]._ColReorder_iOrigCol;
            ...
            _fnMouseDown: function (t, e) {
                ...
                e !== b &&
                    ...
                    (this.s.mouse.offsetX =
                        this._fnCursorPosition(t, "pageX") - n.left),
                    (this.s.mouse.offsetY =
                        this._fnCursorPosition(t, "pageY") - n.top),
            ...
            _fnCreateDragNode: function () {
                ...
                (this.dom.drag = R(s.cloneNode(!1))
                    ...
                    .append(
                        R(n.cloneNode(!1)).append(
                            R(o.cloneNode(!1)).append(r[0])
                        )
                    )
                    .css({
                        position: "absolute",
                    ...
                    (this.dom.pointer = R("<div></div>")
                        ...
                        .css({
                            ...
                            top: R(
                                t
                                    ? R(this.s.dt.nScrollBody).parent()
                                    : this.s.dt.nTable
                            ).offset().top,
                            height: R(
                                t
        ...
        R(s).on("preInit.dt.colReorder", function (t, e) {
            var o;
            "dt" === t.namespace &&
                ((t = e.oInit.colReorder),
                (o = n.defaults.colReorder),
                (t || o) &&
                    ((o = R.extend({}, t, o)), !1 !== t && new r(e, o)));
        }),
