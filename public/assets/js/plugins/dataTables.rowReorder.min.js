...
!(function (o) {
    ...
    function n(t, e) {
        ...
        if (
            ((this.c = v.extend(!0, {}, i.defaults.rowReorder, n.defaults, e)),
            (this.s = {
                bodyTop: null,
                dt: new i.Api(t),
            ...
            (v.extend(n.prototype, {
                ...
                _mouseDown: function (t, e) {
                    var o = this,
                        ...
                        r =
                            ...
                            v(d).width() === v(a).width() &&
                                v(a.body).addClass("dt-rowReorder-noOverflow"),
                            this.dom.dtScroll);
                    (this.s.scroll = {
                        ...
                        var e,
                            ...
                            s =
                                (n &&
                                    ...
                                    (this.s.dropAllowed =
                                        this._rectanglesIntersect(e, o)),
                                    this.s.dropAllowed
                                        ? v(this.dom.cloneParent).removeClass(
                                              "drop-not-allowed"
                                          )
                                        : v(this.dom.cloneParent).addClass(
                                              "drop-not-allowed"
                                          )),
                                this._eventToPage(t, "Y") - this.s.bodyTop),
                            i = this.s.middles,
                ...
                _moveTargetIntoPosition: function (t) {
                    ...
                    (null !== this.s.lastInsert && this.s.lastInsert === t) ||
                        ...
                        (o =
                            t > this.s.lastInsert
                                ? (this.dom.target.insertAfter(e[t - 1]),
                                  "after")
                                : (this.dom.target.insertBefore(e[t]),
                                  "before")),
                        this._cachePositions(),
                        (this.s.lastInsert = t),
    ...
    return (
        ...
        (n.version = "1.4.1"),
        (v.fn.dataTable.RowReorder = n),
        (v.fn.DataTable.RowReorder = n),
        v(a).on("init.dt.dtr", function (t, e, o) {
            var r;
            "dt" === t.namespace &&
                ((t = e.oInit.rowReorder),
                (r = i.defaults.rowReorder),
                (t || r) &&
                    ((r = v.extend({}, t, r)), !1 !== t && new n(e, r)));
        }),
        i
    );
});
